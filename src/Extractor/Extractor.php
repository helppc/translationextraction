...
abstract class Extractor implements IExtractor
{
    ...
    public function setupForms(): self
    {
        ...
        $php->addFunction('setText')
            ...
            ->addFunction('addPasswords', 2)
            ->addFunction('addCountries', 2)
            ->addFunction('addInteger', 2)
            ->addFunction('addPasswords', 3)
            ->addFunction('addPasswords', 4)
            ->addFunction('addSelect', 2)
            ->addFunction('addUrl', 2)
            ->addFunction('addFilteredMultiUpload', 2)
            ->addFunction('addFilteredUpload', 2)
            ->addFunction('addPhone', 2)
            ->addFunction('addIco', 2)
            ->addFunction('addGender', 2)
            ->addFunction('addDate', 2)
            ->addFunction('addVatNumber', 2)
    ...
    public function setupDataGrid(): self
    {
        ...
        $php->addFunction('addColumn', 2)
            ...
            ->addFunction('addGroupSelectAction', 1)
